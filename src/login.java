    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        if (e.getSource()==b1)
        {
            try
            {
                ...
                String sql ="Select * from students where Roll_No='"+t.getText()+"' and pass_word='"+t1.getText().toString()+"'";
                ...
                {JOptionPane.showMessageDialog(null,"Incorrect Password or Roll NO ");}
                c.close();
            }
